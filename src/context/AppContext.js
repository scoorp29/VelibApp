...
export const AppProvider = props => {
    ...
    const api = () => {
        ...
        if (location.coords) {
            return API_URL = "https://opendata.paris.fr/api/records/1.0/search/?dataset=velib-disponibilite-en-temps-reel&rows=50&facet=station_state&geofilter.distance=" + location.coords.latitude + "%2C" + location.coords.longitude + "%2C" + value;
        }
    };
